...
public enum Provenance {
    ...
    /**
     * La frase che l'interfaccia deve pronunciare prima di un contenuto dedotto. Sta qui e non
     * nei singoli agenti perche' quattro agenti che scrivono la stessa avvertenza con quattro
     * parole diverse insegnano all'utente che l'avvertenza non significa niente.
     *
     * @return la frase da anteporre, oppure stringa vuota se non serve alcuna avvertenza
     */
    public String spokenDisclaimer() {
        return needsHumanReview
